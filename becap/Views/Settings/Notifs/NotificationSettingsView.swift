...
struct NotificationSettingsView: View {
    ...
    var body: some View {
        ZStack {
            LinearGradient(
                colors: [Color(red: 27/255, green: 40/255, blue: 74/255), Color(red: 21/255, green: 73/255, blue: 114/255)],
                startPoint: .top,
                endPoint: .bottom
            )
            .ignoresSafeArea()
            ...
            VStack(spacing: 0) {
                        ...
                        Button(action: viewModel.resetAll) {
                            ...
                            .background(
                                Capsule()
                                    .fill(
                                        LinearGradient(
                                            colors: [Color.purple.opacity(0.85), Color.accentColor.opacity(0.85)],
                                            startPoint: .leading,
                                            endPoint: .trailing
                                        )
                                    )
                ...
                Button(action: {
                    ...
                    Text("Enregistrer")
                        ...
                        .background(
                            LinearGradient(
                                colors: [Color(red: 82/255, green: 207/255, blue: 144/255), Color(red: 27/255, green: 188/255, blue: 155/255)],
                                startPoint: .leading,
                                endPoint: .trailing
                            )
                        )
    ...
    private func notificationDayCard(for day: Int) -> some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 28, style: .continuous)
                .fill(
                    LinearGradient(
                        colors: [Color(red: 58/255, green: 107/255, blue: 173/255).opacity(0.88),
